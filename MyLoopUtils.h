...
#ifndef LLVM_TRANSFORMS_UTILS_MY_LOOPUTILS_H
#define LLVM_TRANSFORMS_UTILS_MY_LOOPUTILS_H
...
///
/// Returns true if any modifications are made to the loop.
LLVM_ABI bool formLCSSARecursively(llvm::Loop &L, const DominatorTree &DT,
...
LLVM_ABI bool promoteLoopAccessesToScalars(
    ...
    SmallVectorImpl<llvm::BasicBlock::iterator> &,
    SmallVectorImpl<MemoryAccess *> &, PredIteratorCache &, LoopInfo *,
    DominatorTree *, AssumptionCache *AC, const TargetLibraryInfo *,
    TargetTransformInfo *, Loop *, MemorySSAUpdater &, ICFLoopSafetyInfo *,
...
LLVM_ABI Intrinsic::ID getReductionForBinop(llvm::Instruction::BinaryOps Opc);
...
LLVM_ABI Value *
getShuffleReduction(IRBuilderBase &Builder, Value *Src, unsigned Op,
                    llvm::TargetTransformInfo::ReductionShuffle RS,
                    RecurKind MinMaxKind = RecurKind::None);
...
struct IVConditionInfo {
  ...
  /// condition.
  llvm::SmallVector<llvm::Instruction *> InstToDuplicate;

  /// Constant to indicate for which value the condition is invariant.
  llvm::Constant *KnownValue = nullptr;
  ...
  llvm::BasicBlock *ExitForPath = nullptr;
};
...
#endif // LLVM_TRANSFORMS_UTILS_MY_LOOPUTILS_H
